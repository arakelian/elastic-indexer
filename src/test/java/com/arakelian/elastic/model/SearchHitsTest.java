...
public class SearchHitsTest extends AbstractElasticModelTest {
    public static final SearchHits SAMPLE = ImmutableSearchHits.builder() //
            .total(3) //
            .maxScore(3.0f) //
            .addHit(ImmutableMap.of("_index", "files", "_type", "file", "_id", "one", "_score", 1)) //
            .addHit(ImmutableMap.of("_index", "files", "_type", "file", "_id", "two", "_score", 2)) //
            .addHit(ImmutableMap.of("_index", "files", "_type", "file", "_id", "three", "_score", 3)) //
            .build();
