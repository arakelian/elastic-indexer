...
public class AdjacencyMatrixAggregationTest {
    ...
    public void testJackson() throws IOException {
        JacksonTestUtils.testReadWrite(MINIMAL, AdjacencyMatrixAggregation.class);
    }

    @Test
    public void testSerializable() {
        SerializableTestUtils.testSerializable(MINIMAL, AdjacencyMatrixAggregation.class);
    }
}
