...
public class TruncateTest {
    public static final Truncate SAMPLE = ImmutableTruncate.builder() //
            .length(10) //
            .build();

    @Test
    public void testJackson() throws IOException {
        JacksonTestUtils.testReadWrite(SAMPLE, Truncate.class);
    }

    @Test
    public void testSerializable() {
        SerializableTestUtils.testSerializable(SAMPLE, Truncate.class);
    }
