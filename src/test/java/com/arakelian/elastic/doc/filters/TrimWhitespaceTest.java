...
public class TrimWhitespaceTest {
    public static final TrimWhitespace FILTER = ImmutableTrimWhitespace.of();

    @Test
    public void testJackson() throws IOException {
        JacksonTestUtils.testReadWrite(FILTER, TrimWhitespace.class);
    }

    @Test
    public void testSerializable() {
        SerializableTestUtils.testSerializable(FILTER, TrimWhitespace.class);
    }
