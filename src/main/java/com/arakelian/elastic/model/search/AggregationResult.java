...
@Value.Immutable
@JsonSerialize(as = ImmutableAggregationResult.class)
@JsonDeserialize(builder = ImmutableAggregationResult.Builder.class)
public abstract class AggregationResult implements Serializable {
