 ...
 * 
 * @see <a href=
 *      "https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-metrics-valuecount-aggregation.html">Value
 *      Count Aggregation</a>
 * @see <a href=
...
public interface ValueCountAggregation extends MetricAggregation, ValuesSourceAggregation {
    @Override
    default void accept(final AggregationVisitor visitor) {
        ...
        try {
            if (visitor.enterValueCount(this)) {
                visitor.leaveValueCount(this);
            }
        } finally {
            visitor.leave(this);
        }
