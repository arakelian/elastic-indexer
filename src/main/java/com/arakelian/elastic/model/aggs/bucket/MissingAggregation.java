...
public interface MissingAggregation extends BucketAggregation, ValuesSourceAggregation {
    @Override
    default void accept(final AggregationVisitor visitor) {
        ...
        try {
            if (visitor.enterMissing(this)) {
                visitor.leaveMissing(this);
            }
        } finally {
            visitor.leave(this);
        }
