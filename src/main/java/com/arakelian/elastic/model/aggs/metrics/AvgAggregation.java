...
/**
 * @see <a href=
 *      "https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-metrics-avg-aggregation.html">Avg
 *      Aggregation</a>
 * @see <a href=
...
public interface AvgAggregation extends MetricAggregation, ValuesSourceAggregation {
    @Override
    default void accept(final AggregationVisitor visitor) {
        ...
        try {
            if (visitor.enterAvg(this)) {
                visitor.leaveAvg(this);
            }
        } finally {
            visitor.leave(this);
        }
