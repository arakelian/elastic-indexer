...
/**
 * @see <a href=
 *      "https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-metrics-stats-aggregation.html">Stats
 *      Aggregation</a>
 * @see <a href=
 *      "https://github.com/elastic/elasticsearch/blob/99f88f15c5febbca2d13b5b5fda27b844153bf1a/server/src/main/java/org/elasticsearch/search/aggregations/metrics/stats/StatsAggregationBuilder.java">StatsAggregationBuilder.java</a>
 */
...
public interface StatsAggregation extends MetricAggregation, ValuesSourceAggregation {
    ...
    default void accept(final AggregationVisitor visitor) {
        ...
        try {
            if (visitor.enterStats(this)) {
                visitor.leaveStats(this);
            }
        } finally {
            visitor.leave(this);
        }
